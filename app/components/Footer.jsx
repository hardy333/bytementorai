        ...
        <div className="row">
          <div className="col-lg-4 col-md-6 col-12">
            <div className="mb-4">
              ...
              <div className="mt-4">
                <p>
                  Byte Mentor is feature-rich platform and beautifully UIKit for
                  developers, Built with love and passion in order to make
                  people fill special.
                </p>
          ...
          <div className="col-lg-3 col-md-12">
            <div className="mb-4">
              ...
              <p className="mb-1">
                Email:
                <a href="#">support@byteMmentro.com</a>
              </p>
              <p>
                Phone:
        ...
        <div className="row align-items-center g-0 border-top py-2 mt-6">
          <div className="col-lg-4 col-md-5 col-12">
            <span>
              ...
              ByteMentorAi, Inc. All Rights Reserved
            </span>
          </div>
          ...
          <div className="col-12 col-md-7 col-lg-8 d-md-flex justify-content-end">
            <nav className="nav nav-footer">
              ...
              <a className="nav-link px-2 px-md-3" href="#">
                Cookie Notice
              </a>
