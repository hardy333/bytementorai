...
(function () {
  ...
  dropdownLinks.forEach(function (dropdownLink) {
    dropdownLink.addEventListener("click", function (e) {
      if (!this.nextElementSibling.classList.contains("show")) {
        ...
        const currentlyOpenSubMenus =
          parentDropdownMenu.querySelectorAll(".show");
      ...
      if (parentDropdown) {
        parentDropdown.addEventListener("hidden.bs.dropdown", function (e) {
          const dropdownSubMenus = document.querySelectorAll(
  ...
  if (typedHeading) {
    var typed = new Typed(typedHeading, {
      strings: ["Skills", "Products", "Education", "Future"],
      typeSpeed: 100,
      backSpeed: 40,
      backDelay: 2000,
      loop: true,
